...
const CallButton = ({ phone = STORE_INFO.phone }: { phone?: string }) => {
    return (
        <a
            href={`tel:${phone}`}
            className="fixed bottom-6 right-6 z-50 inline-flex items-center rounded-full bg-copa-red-600 px-5 py-3 text-sm font-semibold text-white shadow-xl shadow-copa-red-500/20 transition hover:bg-copa-red-700 focus:outline-none focus:ring-2 focus:ring-copa-red-500 focus:ring-offset-2 lg:hidden"
        >
            <svg
