                        ...
                        <div className='mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0'>
                            ...
                            <div className='mt-6'>
                                <div className='mt-10 flex'>
                                    <Link
                                        to="/contact"
                                        className='flex max-w-xs flex-1 items-center justify-center rounded-md border border-transparent bg-copa-red-600 px-8 py-3 text-base font-medium text-white hover:bg-copa-red-700 focus:outline-none focus:ring-2 focus:ring-copa-red-500 focus:ring-offset-2 focus:ring-offset-gray-50 sm:w-full'
                                    >
                                        Call for Best Price
                                    </Link>
                                </div>
